...
candi2 = Candidate.create(name: "Marco Rubio", party_id: party2.id, presidencyodds: 5.8, primaryodds: 2.56, betfaircode: 5075277)
candi3 = Candidate.create(name: "Donald Trump", party_id: party2.id, presidencyodds: 10.0, primaryodds: 5.0, betfaircode: 5242353)
candi4 = Candidate.create(name: "Bernie Sanders", party_id: party1.id, presidencyodds: 21.0, primaryodds: 16.5, betfaircode: 6761309)
